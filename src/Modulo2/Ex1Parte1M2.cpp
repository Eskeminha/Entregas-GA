...
int main()
{
	...
	vector<GLuint> VAOs;
	VAOs.push_back(createTriangle(-0.7f,  0.4f, -0.5f,  0.6f, -0.6f,  0.2f));
	VAOs.push_back(createTriangle(-0.2f, -0.3f,  0.1f, -0.4f, -0.1f, -0.6f));
	VAOs.push_back(createTriangle( 0.5f,  0.3f,  0.7f,  0.5f,  0.6f,  0.1f));
	VAOs.push_back(createTriangle( 0.0f,  0.6f,  0.2f,  0.4f, -0.1f,  0.3f));
	VAOs.push_back(createTriangle( 0.4f, -0.2f,  0.6f, -0.3f,  0.5f, -0.5f));
